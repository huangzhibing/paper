	...
	<script type="text/javascript">
		$(document).ready(function() {
			jp.ajaxForm("#inputForm",function(data){
				if(data.success){
				    jp.success(data.msg);
					jp.go("${ctx}/secretarymanage/secretaryManage/departmentsecretaryList");
				}else{
				    jp.error(data.msg);
	...
	<div class="panel panel-primary">
		<div class="panel-heading" >
			<h3 class="panel-title" style="display: inline;">
				<a class="panelButton" href="${ctx}/secretarymanage/secretaryManage/departmentsecretaryList"><i class="ti-angle-left"></i> 返回</a>
			</h3>
