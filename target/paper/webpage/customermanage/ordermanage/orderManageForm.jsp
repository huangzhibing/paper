	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			jp.ajaxForm("#inputForm",function(data){
				if(data.success){
				    jp.success(data.msg);
					jp.go("${ctx}/ordermanage/orderManage");
				}else{
				    jp.error(data.msg);
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/ordermanage/orderManage"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="orderManage" action="${ctx}/ordermanage/orderManage/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input  path="pszj.ZJXM" htmlEscape="false"    class="form-control required"/>
					</div>
				</div>
				<div class="form-group">
