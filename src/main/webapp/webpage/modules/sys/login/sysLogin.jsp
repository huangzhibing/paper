...
<html>
	...
	<body>
		...
		<div class="login-page" style="background:url(${ctxStatic}/common/images/mainback.png) no-repeat center center fixed" >

		<div class="row">

			<div class="col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4" style="background-color:#948F89; padding:25px;border-radius:40px;">
