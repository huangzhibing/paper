	...
	<div class="panel panel-primary">
		...
		<form:hidden path="id"/>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label"><font color="red">*</font>评审等级：</label>
					<div class="col-sm-10">
						<form:radiobuttons path="psdj" items="${fns:getDictList('T_reviewRank')}" itemLabel="label" itemValue="value" htmlEscape="false" class="i-checks required"/>
					</div>
				</div>
				<div class="form-group">
		...
		<c:if test="${mode == 'add' || mode=='edit'}">
		        ...
		        <div class="col-lg-6">
		             <div class="form-group text-center">
		                 <div>
		                     <button id="btnsub" class="btn btn-primary btn-block btn-lg btn-parsley" data-loading-text="正在提交...">提 交</button>
		                 </div>
		             </div>
		        </div>
		</c:if>
