...
<head>
	...
	<%@include file="departmentsecretaryManageList.js" %>
</head>
<body>
			...
			<form:form id="searchForm" modelAttribute="secretaryManage" class="form form-horizontal well clearfix">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<sys:gridselect url="${ctx}/university/university/data" id="university" name="university.gxdm" value="${secretaryManage.university.gxdm}" labelName="university.gxmc" labelValue="${secretaryManage.university.gxdm}"
					title="选择高校代码" cssClass="form-control required" fieldLabels="gxdm|gxmc" fieldKeys="高校代码|高校名称" searchLabels="gxdm|gxmc" searchKeys="高校代码|高校名称" ></sys:gridselect>
			</div>
				<div class="col-xs-12 col-sm-6 col-md-4">
					<label class="label-item single-overflow pull-left" title="学院代码：">学院名称：</label>
					<sys:gridselect url="${ctx}/department/departmentManage/data" id="departmentManage" name="departmentManage.xydm" value="${secretaryManage.departmentManage.xydm}" labelName="departmentManage.xymc" labelValue="${secretaryManage.departmentManage.xymc}"
