	...
	<script type="text/javascript">
		...
		function save() {
            ...
            if(!isValidate){
                ...
                jp.loading();
                jp.post("${ctx}/type/crawTaskType/save",$('#inputForm').serialize(),function(data){
                    if(data.success){
		   ...
		   <tbody>
				<tr>
					...
					<td class="width-35">
						...
						title="父级编号" url="/type/crawTaskType/treeData" extId="${crawTaskType.id}" cssClass="form-control " allowClear="true"/>
					</td>
