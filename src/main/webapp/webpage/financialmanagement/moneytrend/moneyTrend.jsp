...
<head>
	...
	<script type="text/javascript">
        ...
        function Graph(beginDate,endDate,zq) {
            ...
            jp.get("${ctx}/moneytrend/moneyTrend/barGraph?beginDate="+beginDate+"&endDate="+endDate+"&zq="+zq,function (barOption) {
				//折线图
                var lineOption = {};
				...
				for(var i=0;i<dataSize;i++) {
                    ...
                    pieOption.options[i].series[0].data[0].name = '订单个数';
                    pieOption.options[i].series[0].data[1].name = '金额总数';
                }
