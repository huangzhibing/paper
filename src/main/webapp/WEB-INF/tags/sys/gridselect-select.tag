...
<%@ attribute name="targetId" type="java.lang.String" required="true" description="带入框额外值" %>
<%@ attribute name="targetName" type="java.lang.String" required="true" description="带入狂额外名称" %>
		...
		top.layer.open({
		    ...
		    yes: function(index, layero){
		    	 ...
		    	 for(var i=0; i<items.length; i++){
					 ...
					 targetValue.push(item${fn:substring(name, fns:lastIndexOf(name, '.'), fn:length(name))});
		    	 }
		    	 console.log(names);
		    	 $("#${id}Id").val(ids.join(","));
