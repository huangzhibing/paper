...
public class RedisUtil {
    ...
    private static RedisTemplate<String, Object> redisTemplate = SpringContextHolder.getBean("crawRedisTemplate");

    private static StringRedisTemplate stringRedisTemplate = SpringContextHolder.getBean("crawStringRedisTemplate");
