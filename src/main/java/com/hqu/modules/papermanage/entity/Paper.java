...
public class Paper extends DataEntity<Paper> {
	...
	private String jfddh;
	
	private String lwzy;//论文摘要
	
	@ExcelField(title="论文摘要", align=2, sort=13)
	public String getLwzy() {
		return lwzy;
	}

	public void setLwzy(String lwzy) {
		this.lwzy = lwzy;
	}

	public String getJfddh() {
		return jfddh;
	}

	public void setJfddh(String jfddh) {
		this.jfddh = jfddh;
	}
