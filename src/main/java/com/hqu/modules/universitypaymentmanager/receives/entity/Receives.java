 ...
 * @version 2018-10-04
 */
public class Receives extends DataEntity<Receives> {
	...
	private Integer psdj;		// 评审等级
	private String psyj;		// 评审意见
	private List<Papers> papersList = Lists.newArrayList();		// 子表列表
	...
	@ExcelField(title="评审等级", dictType="T_reviewRank", align=2, sort=24)
	...
	@ExcelField(title="评审意见", align=2, sort=25)
	...
	public void setPapersList(List<Papers> papersList) {
