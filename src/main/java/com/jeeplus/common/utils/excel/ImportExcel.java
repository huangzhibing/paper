...
import com.jeeplus.modules.sys.utils.CustomUtils;
			...
			for (Object[] os : annotationList){
				...
				if (val != null){
					...
					try {
						...
						}else if (valType == SpecialityManage.class){
								val = CustomUtils.getSpecialityManageByZYMC(val.toString());
						}else if (valType == ProfessionalTechniqueRank.class){
								val = CustomUtils.getProfessionalTechniqueRandByZYJSJBMC(val.toString());
						}else if (valType == OrganizationManagement.class){
								val = CustomUtils.getOrganizationManagementByDWMC(val.toString());
						}else if (valType == University.class){
							val = new University();
						}else{
							if (ef.fieldType() != Class.class){System.out.println(ef.fieldType());
