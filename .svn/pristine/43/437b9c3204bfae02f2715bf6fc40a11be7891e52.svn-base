...
<head>
	...
	<script type="text/javascript">
        ...
        function Graph(beginDate,endDate) {
            ...
            jp.get("${ctx}/feedback_count/feedback_count/bar?beginDate="+beginDate+"&endDate="+endDate,function (barOption) {
                barChart.setOption(barOption);
            });
            jp.get("${ctx}/feedback_count/feedback_count/pie?beginDate="+beginDate+"&endDate="+endDate,function (pieOption) {
                pieChart.setOption(pieOption);
            });
            jp.get("${ctx}/feedback_count/feedback_count/line?beginDate="+beginDate+"&endDate="+endDate,function (lineOption) {
