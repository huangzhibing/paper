	...
	<script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#search').click(function () {
                ...
                var lwlxdm = $('#lwlxdm').val();
                Graph(beginDate,endDate,lwlxdm);
        ...
        function Graph(beginDate,endDate,lwlxdm) {
            ...
            jp.get("${ctx}/papered_count/papered_count/barGraph?lwlxdm="+lwlxdm,function (barOption) {
                //折线图
                var lineOption = {};
                ...
                for(var i=0;i<dataSize;i++) {
                    ...
                    pieOption.options[i].series[0].data[1].value = 0;
                    pieOption.options[i].series[0].data[0].name = '学士论文';
                    pieOption.options[i].series[0].data[1].name = '硕士论文';
                }
...
<body>
	...
	<div class="accordion-group">
		...
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="moneyTrend" target="rfFrame" class="form form-horizontal well clearfix">
