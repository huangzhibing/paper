 ...
 */
package com.hqu.modules.paperreview.entity;
 ...
 * @version 2018-09-01
 */
public class PaperReview extends DataEntity<PaperReview> {
	...
	private StudentManage student;
	private Integer psdj;
	private String psyj;
	private Integer psfs;//评审分数
	
	
	public Integer getPsfs() {
		return psfs;
	}

	public void setPsfs(Integer psfs) {
		this.psfs = psfs;
	}

	public Integer getPsdj() {
		return psdj;
	}

	public void setPsdj(Integer psdj) {
		this.psdj = psdj;
	}
	...
	public StudentManage getStudent() {
		return student;
	}

	public void setStudent(StudentManage student) {
